      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.storefront_outlined, size: 100, color: primaryBlue),
          ),
          ...
          Text(
            "Experience the taste of 100% organic and fresh dairy products delivered directly from local farmers.",
